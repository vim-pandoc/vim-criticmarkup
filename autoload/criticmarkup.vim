...
function! criticmarkup#InjectHighlighting()
    ...
    hi criticAdd guibg=#00ff00 guifg=#101010 ctermbg=green
    hi criticDel guibg=#ff0000 guifg=#ffffff ctermbg=red ctermfg=white
    ...
    hi criticMeta guibg=#0099FF guifg=#101010 ctermbg=blue
    hi criticHighlighter guibg=#ffff00 guifg=#101010 ctermbg=yellow
