...
function! criticmarkup#InjectHighlighting()
    syn region criticAddition matchgroup=criticAdd start=/{++/ end=/++}/ containedin=pandocDefinitionBlock,yamlBlock,yamlHeader concealends
    syn region criticDeletion matchgroup=criticDel start=/{--/ end=/--}/ containedin=pandocDefinitionBlock,yamlBlock,yamlHeader concealends
    syn region criticSubstitutionDeletion start=/{\~\~/ end=/.\(\~>\)\@=/ containedin=pandocDefinitionBlock,yamlBlock,yamlHeader keepend
    syn region criticSubstitutionAddition start=/\~>/ end=/\~\~}/ containedin=pandocDefinitionBlock,yamlBlock,yamlHeader keepend
    ...
    syn region criticComment matchgroup=criticMeta start=/{>>/ end=/<<}/ containedin=pandocDefinitionBlock,yamlBlock,yamlHeader concealends
    syn region criticHighlight matchgroup=criticHighlighter start=/{==/ end=/==}/ containedin=pandocDefinitionBlock,yamlBlock,yamlHeader concealends
